...
//	FiGeo(float, float);
//	void wypisz() {
//		printf("srodek kola/trapezu : (%f,%f)", x, y);
//	}
//};
...
//public:
//	static double l;
//	Trapez() :FiGeo(), nast(NULL), a(1), b(1), h(1) {
//		l = l + ((a + b)*h) / 2;
//	}
...
//	Trapez(Kolo &Kolo);
//	~Trapez() {
//		printf("Destruktor klasy Trapez obiektu A:%f B:%f H:%f  ", a, b, h);
//		l = l - ((a + b)*h) / 2;
//		printf(" Pomniejszone Pole K:%f ", l);
//		FiGeo::wypisz();
//		putchar('\n');
//		delete nast;
//	}
...
//	Kolo(Trapez &trapez);
//	~Kolo() {
//		printf("Destruktor klasy Kolo obiektu R:%f  ", r);
//		l2 = l2 - (3.14*(r*r));
//		printf(" Pomniejszone Pole T:%f ", l2);
//		FiGeo::wypisz();
//		putchar('\n');
//		delete nast;
//	}
...
//		delete htrap;
//		delete hkolo;
//		printf("usunieto liste kol oraz trapezow\n");
//	}
...
//double Trapez::l = 0;
////----------------------------------------------------------------
//FiGeo::FiGeo(FiGeo &f) :x(f.x), y(f.y) {
//}
//
//FiGeo::FiGeo(float fx, float fy) {
//	x = fx;
//	y = fy;
//}
//
////----------------------------------------------------------------
//blejtram::blejtram() :htrap(NULL), hkolo(NULL) {
//}
...
//	}
//	htrap = head2;
//	printf("Pole wszystkich kol:%f\n", Kolo::l2);
//	printf("Pole wszystkich Trapezow:%f\n", Trapez::l);
//}
...
//}
//
//Trapez::Trapez(Trapez &trapez) :FiGeo(trapez.x, trapez.y), nast(NULL), a(trapez.a), b(trapez.b), h(trapez.h) {
//	l = l + ((a + b)*h) / 2;
//}
